...
controle_dir = os.path.abspath(os.path.join(parent_dir, "Controle"))
print(f"Adicionando {controle_dir} ao sys.path")
if controle_dir not in sys.path:
    sys.path.append(controle_dir)
